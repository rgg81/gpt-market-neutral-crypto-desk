...
- [c24] The book's alpha net of beta was negative in 4 of the last 6 scored cycles, including c22 and c23 after the c22 calibration. For each discretionary new or flipped non-BTC seat, rank eligible carry-positive candidates by side-aligned mean specialist conviction and reject a candidate opposed by any specialist at conviction >= 0.60 when another candidate on that side has comparable carry and real-size friction without that opposition. Use conviction only as a selection filter, never a notional booster; record the ordered comparison and any neutrality-, deployment-, or hold-rule-forced exception. retire_if: alpha_frac > 0 over 3 consecutive scored cycles by c30.
<!-- REFLECTOR:END -->
