...
- [c13] The book's alpha net of beta was negative in 4 of the last 6 scored cycles (c7 alpha_frac=-0.0019, c9=-0.0089, c10=-0.0063, c12=-0.0029). Before constructing the book, rank every non-BTC candidate by side-aligned cross-specialist corroboration and conviction; select the highest-ranked available names on each side and size non-hedge gross monotonically by that rank. If neutrality forces a lower-ranked leg or a rank exception, identify it and give an explicit leg-level reason; preserve the >=90% deployment and dollar/beta-neutrality mandates. retire_if: alpha_frac > 0 over 3 consecutive scored cycles by c19.
<!-- REFLECTOR:END -->
