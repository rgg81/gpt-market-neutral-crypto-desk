...
- [c22] The book's alpha net of beta remained negative in 3 of the last 6 scored cycles (c17 alpha_frac=-0.0056, c18 alpha_frac=-0.0005, c21 alpha_frac=-0.0038). Rank every non-BTC candidate on each side by side-aligned cross-specialist corroboration and mean conviction, then reserve above-median non-hedge notional for legs with three side-aligned specialist reads; size all other eligible legs no larger than the median non-hedge leg. Record the ordered ranking, scores, and any carry-, neutrality-, or deployment-forced exception with a leg-level reason. retire_if: alpha_frac > 0 over 3 consecutive scored cycles by c28.
<!-- REFLECTOR:END -->
