...
- [c19] The book's alpha net of beta was negative in 4 of the last 6 scored cycles (c13 alpha_frac=-0.0031, c14=-0.0025, c17=-0.0056, c18=-0.0005). Before construction, rank every non-BTC candidate on each side by side-aligned cross-specialist corroboration and mean conviction. Select the highest-ranked eligible names and size non-hedge gross monotonically by corroboration count and then mean conviction; do not give an above-median alpha allocation to a leg lacking two side-aligned specialist reads. Record the ordered ranking and scores for every selected alpha leg. If carry eligibility, dollar/beta neutrality, or the >=90% deployment mandate forces a lower-ranked selection or sizing exception, identify it and give an explicit leg-level reason. retire_if: alpha_frac > 0 over 3 consecutive scored cycles by c25.
<!-- REFLECTOR:END -->
