...
- [c15] The book's alpha net of beta was negative in 5 of the last 6 scored cycles (c9 alpha_frac=-0.0089, c10=-0.0063, c12=-0.0029, c13=-0.0031, c14=-0.0025). Before construction, rank every non-BTC candidate on each side by side-aligned cross-specialist corroboration and mean conviction. In notes, record that ordered ranking and the score used for every selected alpha leg; select the highest-ranked eligible names and size non-hedge gross monotonically by rank. If neutrality or carry eligibility forces a lower-ranked leg or sizing exception, identify it and give an explicit leg-level reason; preserve the >=90% deployment and dollar/beta-neutrality mandates. retire_if: alpha_frac > 0 over 3 consecutive scored cycles by c21.
<!-- REFLECTOR:END -->
