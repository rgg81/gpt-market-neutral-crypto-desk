...
- [c21] Futures conviction-weighted directional calls were negative in 3 of the last 6 scored cycles (c15 edge=-0.0045 hit=0.33, c16 edge=-0.0022 hit=0.25, c20 edge=-0.0036 hit=0.38). Return a non-flat read only when side-aligned expected funding carry is cross-sectionally extreme and corroborated by at least two independent side-consistent signals among rising OI, the long/short ratio, and wide basis; otherwise return flat. Keep every non-flat conviction capped at 0.4 and continue to report the selected side's carry precisely. retire_if: futures conviction-weighted edge >= 0 and hit_rate >= 0.50 over 3 consecutive scored cycles by c27.
<!-- REFLECTOR:END -->
