...
- [c16] Futures conviction-weighted directional calls were negative in 3 of the last 6 scored cycles (c10 edge=-0.0015 hit=0.50, c11 edge=-0.0022 hit=0.40, c15 edge=-0.0045 hit=0.33). Return a non-flat read only when side-aligned expected funding carry is cross-sectionally extreme and independently corroborated by rising OI with a side-consistent long/short ratio or by wide basis; otherwise return flat. Keep every non-flat conviction capped at 0.4 and continue to report the selected side's carry precisely. retire_if: conv_weighted_edge >= 0 and hit_rate >= 0.5 over 3 consecutive scored cycles by c22.
<!-- REFLECTOR:END -->
