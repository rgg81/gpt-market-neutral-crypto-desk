...
- [c24] Technical conviction-weighted calls were negative in 5 of the last 6 scored cycles, including c22 and c23 after the c22 calibration. Before assigning conviction above 0.40, require the call's side to be in the outer cross-sectional momentum quartile and its |momentum_pct|/realized_vol strength to be in the strongest quartile; cite both ranks and the underlying numbers in the rationale. Otherwise cap conviction at 0.40, and never count unavailable chart-path features as confirmation. retire_if: technical conviction-weighted edge > 0 and hit_rate >= 0.50 over 3 consecutive scored cycles by c30.
<!-- REFLECTOR:END -->
